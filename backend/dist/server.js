...
const adminOrders_js_1 = __importDefault(require("./routes/adminOrders.js"));
const adminDashboard_js_1 = __importDefault(require("./routes/adminDashboard.js"));
...
app.use('/api/admin/orders', adminOrders_js_1.default);
app.use('/api/admin/dashboard-stats', adminDashboard_js_1.default);
